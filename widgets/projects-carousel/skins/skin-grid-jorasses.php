<?php
namespace AloneAddons\Widgets\Projects_Carousel\Skins;
	...
	protected function render_post() {
      ...
      <article id="post-<?php the_ID();  ?>" <?php post_class( 'elementor-project' ); ?>>
            ...
            if( '' !== $this->parent->get_instance_value_skin('show_category') ) {
  						the_terms( $form_id, 'project_category', '<div class="elementor-project__category">' . alone_addons_get_icon_svg('tags', 14) , ', ', '</div>' );
  					}
  				?>
  			</div>
  		</article>
