...
class Skin_Cruces extends Skin_Base {
	...
	public function register_design_image_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-member__thumbnail' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				],
				'default' => [
					'size' => '',
				],
