<?php
namespace AloneAddons\Widgets\Members_Carousel\Skins;
    ...
    $this->start_controls_section(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-member__email' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_batura_show_email!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-member__email:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_batura_show_email!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-member__email',
				'condition' => [
					'skin_batura_show_email!' => '',
				],
			]
					...
					<div class="elementor-member__thumbnail">
						...
						<div class="elementor-member__infor">
							<?php
								...
								if( '' !== $this->parent->get_instance_value_skin('show_email') ) {
									echo $this->parent->render_email();
								}
							?>
						</div>
					</div>
