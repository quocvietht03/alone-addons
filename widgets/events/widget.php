<?php
namespace AloneAddons\Widgets\Events;
...
class Be_Events extends Widget_Base {
	...
	public function get_title() {
		return __( 'Be Events', 'alone-addons' );
	}
	...
	protected function register_query_section_controls() {
		...
		$this->add_control(
			'coming_soon',
			[
				'label' => __( 'Coming Soon', 'alone-addons' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'event_start_date',
			[
				'label' => __( 'Event Start Date', 'alone-addons' ),
		...
		$this->add_control(
			'event_end_date',
			[
				'label' => __( 'Event End Date', 'alone-addons' ),
				'type' => Controls_Manager::DATE_TIME,
				'condition' => [
					'coming_soon' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => 'post_date',
				'options' => [
					'event_start_date' => __( 'Event Start Date', 'alone-addons' ),
			...
			?>
				<div class="<?php echo esc_attr( $classes ); ?>">
					<ul class="elementor-filter" data-type="event">
						<?php
							echo '<li>
										<a class="elementor-filter__link active" href="#" data-filter="all">' . esc_html__( 'All Events', 'alone-addons' ) . '</a>
									</li>';
			...
			<div class="elementor-event__content">
				...
				<?php if( '' !== $settings['show_meta'] ) { ?>
					<ul class="elementor-event__meta">
						<?php
							echo tribe_events_event_schedule_details( get_the_ID(), '<li>' . alone_addons_get_icon_svg( 'clock', 14 ), '</li>' );
								$venue_id = get_post_meta( get_the_ID(), '_EventVenueID', true);
								if( $venue_id ) {
									echo '<li>' . alone_addons_get_icon_svg( 'map-marker', 16 );
