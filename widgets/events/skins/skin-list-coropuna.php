...
class Skin_List_Coropuna extends Skin_Base {
	...
	public function get_title() {
		return __( 'List Coropuna', 'alone-addons' );
	}
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_list_coropuna_show_read_more!' => '',
				],
			]
		);
    	...
    	$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event__read-more svg' => 'fill: {{VALUE}};',
				],
        	'condition' => [
					'skin_list_coropuna_show_read_more!' => '',
				],
    	...
    	$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					' {{WRAPPER}} .elementor-event__read-more:hover svg' => 'fill: {{VALUE}};',
				],
        	'condition' => [
					'skin_list_coropuna_show_read_more!' => '',
				],
	...
	protected function render_post() {
        ...
        ?>
          ...
          <?php
            if( '' !== $this->parent->get_instance_value_skin( 'show_read_more' ) ) {
              echo '<a class="elementor-event__read-more" href="' . get_the_permalink() . '">' . alone_addons_get_icon_svg( 'arrow-long-right', 26 ) . '</a>';
            }
          ?>
