...
class Skin_List_Gangri extends Skin_Base {
	...
	public function get_id() {
		return 'skin-list-gangri';
	}


	public function get_title() {
		return __( 'List Gangri', 'alone-addons' );
	}
	...
	public function register_layout_controls( Widget_Base $widget ) {
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_list_gangri_show_thumbnail!'=> '',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_list_gangri_show_read_more!' => '',
				],
			]
		);
	}
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_list_gangri_show_organizer!' => '',
				],
			]
		);
