...
class Skin_List_Jorasses extends Skin_Base {
	...
	public function get_title() {
		return __( 'List Jorasses', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_list_jorasses_show_thumbnail!'=> '',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Get A Ticket', 'alone-addons' ),
				'condition' => [
					'skin_list_jorasses_show_read_more!' => '',
				],
			]
		);
	}
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_list_jorasses_show_address!' => '',
				],
			]
		);
          ...
          <div class="elementor-event__thumbnail-wrap">
            ...
            if( $venue_id && '' !== $this->parent->get_instance_value_skin( 'show_address' ) ) {
              echo '<div class="elementor-event__address">' .
                alone_addons_get_icon_svg( 'map-marker', 24 );
