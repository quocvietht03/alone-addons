...
class Skin_List_Taboche extends Skin_Base {
	...
	public function get_id() {
		return 'skin-list-taboche';
	}


	public function get_title() {
		return __( 'List Taboche', 'alone-addons' );
	}
  ...
  public function register_design_box_section_controls( Widget_Base $widget ) {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-event .elementor-event__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
				'separator' => 'after',
			]
		);
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elementor-event__date' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'skin_list_taboche_show_date!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event__date:before' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'skin_list_taboche_show_date!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Month Typography', 'alone-addons' ),
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-event__date .month',
				'condition' => [
					'skin_list_taboche_show_date!' => '',
				],
			]
    	...
    	$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_list_taboche_show_address!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_list_taboche_show_read_more!' => '',
				],
			]
		);
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'read_more_typography_hover',
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-event__read-more:hover',
				'condition' => [
					'skin_list_taboche_show_read_more!' => '',
				],
			]
	...
	protected function render_post() {
        ...
        ?>
          ...
          <?php if( '' !== $this->parent->get_instance_value_skin( 'show_meta' ) ) { ?>
            <ul class="elementor-event__meta">
              <?php
                ...
                echo '<li class="time">'  . alone_addons_get_icon_svg( 'clock', 14 ) . tribe_get_start_date( get_the_ID(), false, $time_format ) . '</li>';
          ...
          if( $venue_id ) {
            echo '<div class="elementor-event__address">' . alone_addons_get_icon_svg( 'map-marker', 14 );
          ...
          <?php
            if( '' !== $this->parent->get_instance_value_skin( 'show_read_more' ) ) {
              echo '<a class="elementor-event__read-more" href="' . get_the_permalink() . '">'  . esc_html__( 'Read More', 'alone-addons' ) . '</a>';
            }
          ?>
