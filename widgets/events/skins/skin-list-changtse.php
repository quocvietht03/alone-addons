...
class Skin_List_Changtse extends Skin_Base {
	...
	public function get_id() {
		return 'skin-list-changtse';
	}


	public function get_title() {
		return __( 'List Changtse', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_list_changtse_show_thumbnail!'=> '',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_list_changtse_show_read_more!' => '',
				],
			]
		);
	}
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    	...
    	$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_list_changtse_show_category!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event .event-cate-list' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_list_changtse_show_category!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-event .event-cate-list',
				'condition' => [
					'skin_list_changtse_show_category!' => '',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event__date-tile' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_list_changtse_show_date!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-event__date-tile',
				'condition' => [
					'skin_list_changtse_show_date!' => '',
				],
			]
    ...
    $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event .tribe-date' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_list_changtse_show_date!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-event .tribe-date',
				'condition' => [
					'skin_list_changtse_show_date!' => '',
				],
			]
    ...
    $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_list_changtse_show_address!' => '',
				],
			]
		);
    ...
    $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event__address-tile' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_list_changtse_show_address!' => '',
				],
        ...
        'label' => __( 'Title Typography', 'alone-addons' ),
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-event__address-tile',
				'condition' => [
					'skin_list_changtse_show_address!' => '',
				],
			]
    ...
    $this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-event__read-more' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
        'condition' => [
					'skin_list_changtse_show_read_more!' => '',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-event__read-more' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
        'condition' => [
					'skin_list_changtse_show_read_more!' => '',
				],
    ...
    if( '' !== $this->parent->get_instance_value_skin( 'show_thumbnail' ) ) {
      $post_classes .= ' has-thumbnail';
        ...
        <?php if( '' !== $this->parent->get_instance_value_skin( 'show_thumbnail' ) ) { ?>
          ...
          <div class="elementor-event__content-header">
    				<?php
              if( '' !== $this->parent->get_instance_value_skin( 'show_category' ) ) {
                echo get_the_term_list(get_the_ID(), 'tribe_events_cat', '<div class="event-cate-list">',  ', ',  '</div>');
              }
          ...
          <div class="elementor-event__content-info">
            <?php
              $country   = tribe_get_country( get_the_ID() );
              if( $country && '' !== $this->parent->get_instance_value_skin( 'show_address' ) ) {
                echo '<div class="elementor-event__address">
                  <h3 class="elementor-event__address-tile">' . esc_html__( 'Event In:', 'alone-addons' ) . '</h3>
                  <span class="tribe-address">'. $country .'</span>';
                echo '</div>';
              }
              $date   = get_post_meta( get_the_ID(), '_EventStartDateUTC', true );
              $date_stars = date_i18n('d M Y', strtotime($date));
              if( $date && '' !== $this->parent->get_instance_value_skin( 'show_date' ) ) {
                echo '<div class="elementor-event__date">
                  <h3 class="elementor-event__date-tile">' . esc_html__( 'Date:', 'alone-addons' ) . '</h3>
                  <span class="tribe-date">'. $date_stars .'</span>';
                echo '</div>';
              }
            ?>
          </div>
