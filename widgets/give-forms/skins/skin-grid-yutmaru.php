  ...
  public function register_design_give_form_section_controls(Widget_Base $widget) {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--yutmaru"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-gateway-radio-list > li label:hover,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-gateway-radio-list > li.give-gateway-option-selected label,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give_terms_agreement label:hover,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give_terms_agreement input[type=checkbox]:checked + label,
					 .give-form[data-style="elementor-give-forms--yutmaru"] .give_terms_links:hover,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.give-form[data-style="elementor-give-forms--yutmaru"] .give-total-wrap .give-currency-symbol,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give_terms_agreement input[type=checkbox]:checked + label:before,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
					'.give-form[data-style="elementor-give-forms--yutmaru"] #give-donation-level-button-wrap .give-btn:hover,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 .give-form[data-style="elementor-give-forms--yutmaru"] #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--yutmaru"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--yutmaru"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--yutmaru"] legend,
					 .give-form[data-style="elementor-give-forms--yutmaru"] .give-submit' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--yutmaru"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--yutmaru"] .give-submit' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--yutmaru"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--yutmaru"] .give-submit:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
					...
					if( '' !== $this->parent->get_instance_value_skin( 'show_donation_button' ) ) {
						if( !Template::getActiveID($form_id) ) {
							...
							add_filter('give_form_html_tags', function($form_html_tags, $form) {
								$form_html_tags['data-style'] = 'elementor-give-forms--yutmaru';
