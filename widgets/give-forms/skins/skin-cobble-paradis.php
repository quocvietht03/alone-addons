    ...
    $this->add_responsive_control(
      ...
      [
        ...
        'type' => Controls_Manager::NUMBER,
				'default' => 320,
        'selectors' => [
          '{{WRAPPER}} .give-card__media' => 'padding-bottom: {{SIZE}}px;',
        ],
				'condition' => [
					'skin_cobble_paradis_show_thumbnail!'=> '',
				],
	...
	public function registerd_design_layout_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-col' => 'margin-bottom: {{SIZE}}{{UNIT}};
																					 padding-left: calc({{SIZE}}{{UNIT}} / 2);
                                           padding-right: calc({{SIZE}}{{UNIT}} / 2);',
          '{{WRAPPER}} .elementor-row' => 'width: calc(100% + {{SIZE}}{{UNIT}});
	...
	public function render() {
      ...
      $this->parent->render_loop_header();
        ...
        $count = 0;
          ...
          if( $count % 2 != 0 || $count == $this->parent->get_instance_value_skin('posts_per_page') ) {
            echo '</div>';
          }
          $count++;
				}
