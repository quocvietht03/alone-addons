...
class Skin_Grid_Wilson extends Skin_Base {
	...
	public function get_title() {
		return __( 'Grid Wilson', 'alone-addons' );
	}
  ...
  public function register_design_content_section_controls(Widget_Base $widget) {
    ...
    $this->add_control(
      ...
      [
        'label' => __( 'Background Progress', 'alone-addons' ),
        'type' => Controls_Manager::COLOR,
        'default' => '',
        'selectors' => [
						...
						<div class="give-goal-progress">
							<div class="bt-price">
								...
								echo '<div class="bt-goal">'.$total_goal.'</div>'.
									'<div class="bt-collected">'.$goal_percentage_completed.esc_html__('% Donation Collected', 'alone-addons').'</div>';
								?>
							</div>
