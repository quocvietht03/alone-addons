    ...
    public function register_design_give_form_section_controls(Widget_Base $widget) {
			...
			[
				...
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--swiss"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-forms--swiss"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					 .give-form[data-style="elementor-give-forms--swiss"] #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					...
					'.give-form[data-style="elementor-give-forms--swiss"] .give-total-wrap .give-currency-symbol,
					 ...
					 .give-form[data-style="elementor-give-forms--swiss"] #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 .give-form[data-style="elementor-give-forms--swiss"] #give_terms_agreement input[type=checkbox]:checked + label:before,
					 .give-form[data-style="elementor-give-forms--swiss"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--swiss"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--swiss"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--swiss"] legend,
					 .give-form[data-style="elementor-give-forms--swiss"] .give-submit' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--swiss"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'.give-form[data-style="elementor-give-forms--swiss"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
