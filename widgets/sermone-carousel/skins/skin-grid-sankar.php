    ...
    $this->start_controls_section(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-sermon,
           {{WRAPPER}} .elementor-sermon.has-thumbnail .elementor-sermon__author,
           {{WRAPPER}} .elementor-sermon.has-thumbnail .elementor-sermon__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
        'condition' => [
					'skin_grid_sankar_show_quickview!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-sermon__quickview span' => 'background-color: {{VALUE}};',
				],
        'condition' => [
					'skin_grid_sankar_show_quickview!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-sermon__quickview span:hover' => 'background-color: {{VALUE}};',
				],
        'condition' => [
					'skin_grid_sankar_show_quickview!' => '',
				],
          ...
          ?>
					...
					<?php if( '' !== $this->parent->get_instance_value_skin( 'show_meta' ) ) { ?>
						<ul class="elementor-sermon__meta">
							<li>
								<?php
									echo __( 'On ', 'alone-addons' ) .
											 sermone_date_format( '', sermone_get_field( 'sermon_date_preached', get_the_ID() ) );
								?>
							</li>
		          <li>
								<?php echo get_the_term_list( get_the_ID(), 'sermone_preacher', __( 'By ', 'alone-addons' ), ', ', '.' ) ?>
							</li>
		        </ul>
					<?php } ?>
