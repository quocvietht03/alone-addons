...
class Skin_Grid_Michelson extends Skin_Base {
	...
	public function get_id() {
		return 'skin-grid-michelson';
	}


	public function get_title() {
		return __( 'Grid Michelson', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_michelson_show_thumbnail!'=> '',
				],
			]
		);
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_michelson_show_title!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
        'condition' => [
					'skin_grid_michelson_show_quickview!' => '',
				],
			]
		);
