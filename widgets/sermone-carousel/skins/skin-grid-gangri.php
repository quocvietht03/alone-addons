<?php
namespace AloneAddons\Widgets\Sermone_Carousel\Skins;
...
class Skin_Grid_Gangri extends Skin_Base {

	protected function _register_controls_actions() {
		add_action( 'elementor/element/be-sermone-carousel/section_layout/before_section_end', [ $this, 'register_layout_controls' ] );
		add_action( 'elementor/element/be-sermone-carousel/section_design_layout/before_section_end', [ $this, 'registerd_design_layout_controls' ] );
		add_action( 'elementor/element/be-sermone-carousel/section_design_layout/after_section_end', [ $this, 'register_design_box_section_controls' ] );
		add_action( 'elementor/element/be-sermone-carousel/section_design_layout/after_section_end', [ $this, 'register_design_image_section_controls' ] );
		add_action( 'elementor/element/be-sermone-carousel/section_design_layout/after_section_end', [ $this, 'register_design_content_section_controls' ] );

	}

	public function get_id() {
		return 'skin-grid-gangri';
	}


	public function get_title() {
		return __( 'Grid Gangri', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_gangri_show_thumbnail!'=> '',
				],
			]
		);
  ...
  public function register_design_box_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
			'content_bg_color',
			[
				'label' => __( 'Content Background Color', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-sermon__content' => 'background-color: {{VALUE}}',
				],
			]
		);
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
		...
		$this->add_control(
			'heading_speaker_style',
			[
				'label' => __( 'Speaker', 'alone-addons' ),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_gangri_show_speaker!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-sermon__speaker' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_gangri_show_speaker!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-sermon__speaker',
				'condition' => [
					'skin_grid_gangri_show_speaker!' => '',
				],
			]
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-sermon__date' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_gangri_show_date!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-sermon__date',
				'condition' => [
					'skin_grid_gangri_show_date!' => '',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
        'condition' => [
					'skin_grid_gangri_show_quickview!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-sermon__quickview' => 'color: {{VALUE}};',
				],
        'condition' => [
					'skin_grid_gangri_show_quickview!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-sermon__quickview' => 'background-color: {{VALUE}};',
				],
        'condition' => [
					'skin_grid_gangri_show_quickview!' => '',
				],
    ...
    $post_classes = 'elementor-sermon';
      ...
      <article id="post-<?php the_ID();  ?>" <?php post_class( $post_classes ); ?> >
        <?php if( '' !== $this->parent->get_instance_value_skin( 'show_thumbnail' ) ) { ?>
          ...
          <?php
            if( '' !== $this->parent->get_instance_value_skin( 'show_speaker' ) ) {
              echo '<div class="elementor-sermon__speaker">' .
                     get_the_term_list( get_the_ID(), 'sermone_preacher',  __( 'Speaker: ', 'alone-addons' ), ', ', '.' ) .
                   '</div>';
            }
          ?>
          ...
          <?php
            if( '' !== $this->parent->get_instance_value_skin( 'show_date' ) ) {
              echo '<div class="elementor-sermon__date">' .
