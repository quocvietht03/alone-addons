    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elementor-post__date a svg' => 'fill: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_jorasses_show_date!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-post__date' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'skin_grid_jorasses_show_date!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .elementor-post__meta li a svg' => 'fill: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_jorasses_show_meta!' => '',
				],
        ...
        <div class="elementor-post__content">
          <?php
						if( '' !== $this->parent->get_instance_value_skin('show_read_more' ) ){
							echo '<a class="elementor-post__read-more" href="' . get_the_permalink() . '">' . alone_addons_get_icon_svg('link', 16) . '</a>';
						}
					?>
