...
class Skin_Jimara extends Skin_Base {
  ...
  public function register_layout_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			'light_text',
			[
				'label' => __( 'Light Text', 'alone-addons' ),
	...
	public function register_design_icon_section_controls( Widget_Base $widget ) {
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-icon-box:before' => 'background-color: {{VALUE}};',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-icon-box:hover:before' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	public function register_design_content_section_controls( Widget_Base $widget ) {
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'typography_light_text',
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-icon-box__light',
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-icon-box__light' => 'color: {{VALUE}};',
				],
			]
		);

        $this->add_control(
			'light_text_background_color',
			[
				'label' => __( 'Background_Color', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-icon-box__light' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .elementor-icon-box__light:before' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	public function render() {
		...
		<div class="elementor-icon-box__content">
			<?php
                ...
                if( $this->parent->get_instance_value_skin('light_text') ) {
                    echo '<div class="elementor-icon-box__light">' . $this->parent->get_instance_value_skin('light_text') . '</div>';
                }
