...
class Skin_List_Coropuna extends Skin_Base {
			...
			[
				...
				'default' => [
					...
					[
						'list_content' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'alone-addons' ),
						'list_image' => Utils::get_placeholder_image_src(),
						'list_name' => __( 'Name #4', 'alone-addons' ),
						'list_job' => 'Job #4',
					],
					[
						'list_content' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'alone-addons' ),
						'list_image' => Utils::get_placeholder_image_src(),
						'list_name' => __( 'Name #5', 'alone-addons' ),
						'list_job' => 'Job #5',
					],
				],
  ...
  public function register_design_box_content_section_controls( Widget_Base $widget ) {
    ...
    $this->start_controls_section(
			...
			[
				'label' => __( 'Box Content', 'alone-addons' ),
  ...
  public function register_design_box_thumbnail_section_controls( Widget_Base $widget ) {
    ...
    $this->start_controls_section(
			...
			[
				'label' => __( 'Box Thumbnail', 'alone-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
  ...
  protected function render_loop_thumbs_footer() {
	...
	public function render() {
        ...
        <div class="elementor-testimonial__icon">
          <?php echo alone_addons_get_icon_svg( 'quote', 56 ); ?>
        </div>
