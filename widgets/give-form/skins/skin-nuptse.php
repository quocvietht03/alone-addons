		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.give-form[data-style="elementor-give-form--nuptse"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-form--nuptse"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					...
					'.give-form[data-style="elementor-give-form--nuptse"] .give-total-wrap .give-currency-symbol,
					 .give-form[data-style="elementor-give-form--nuptse"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 ...
					 .give-form[data-style="elementor-give-form--nuptse"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
					'.give-form[data-style="elementor-give-form--nuptse"] #give-donation-level-button-wrap .give-btn:hover,
					 .give-form[data-style="elementor-give-form--nuptse"] #give-donation-level-button-wrap .give-btn.give-default-level,
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-form--nuptse"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-form--nuptse"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] .give-btn-modal,
					 .give-form[data-style="elementor-give-form--nuptse"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] .give-btn-modal:hover,
					 .give-form[data-style="elementor-give-form--nuptse"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
