...
class Skin_Vaccine extends Skin_Base {
	...
	public function get_title() {
		return __( 'Vaccine', 'alone-addons' );
	}
    ...
    $this->add_control(
			...
			[
				...
				'default' => __( 'Give your sharing', 'alone-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Donation for vaccine', 'alone-addons' ),
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				'label' => __( 'Main Color Popup', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-form--vaccine"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-form--vaccine"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					...
					'.give-form[data-style="elementor-give-form--vaccine"] .give-total-wrap .give-currency-symbol,
					 .give-form[data-style="elementor-give-form--vaccine"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 ...
					 .give-form[data-style="elementor-give-form--vaccine"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
					'.give-form[data-style="elementor-give-form--vaccine"] #give-donation-level-button-wrap .give-btn:hover,
					 .give-form[data-style="elementor-give-form--vaccine"] #give-donation-level-button-wrap .give-btn.give-default-level,
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-form--vaccine"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-form--vaccine"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] > .give-btn,
					 .give-form[data-style="elementor-give-form--vaccine"] legend,
					 .give-form[data-style="elementor-give-form--vaccine"] .give-submit' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] .give-btn-modal,
					 .give-form[data-style="elementor-give-form--vaccine"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] .give-btn-modal:hover,
					 .give-form[data-style="elementor-give-form--vaccine"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
