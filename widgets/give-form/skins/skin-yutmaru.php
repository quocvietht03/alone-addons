...
class Skin_Yutmaru extends Skin_Base {
	...
	public function get_title() {
		return __( 'Yutmaru', 'alone-addons' );
	}
	...
	public function register_layout_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Make a Donation', 'alone-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Sociis aute euismod, vulputate. Porta amet tortor nibh wisi saepe.', 'alone-addons' ),
			]
		);
