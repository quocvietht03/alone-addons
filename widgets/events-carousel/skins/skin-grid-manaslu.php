...
class Skin_Grid_Manaslu extends Skin_Base {
	...
	public function get_id() {
		return 'skin-grid-manaslu';
	}


	public function get_title() {
		return __( 'Grid Manaslu', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_manaslu_show_thumbnail!'=> '',
				],
			]
		);
    ...
    $this->start_controls_section(
    	...
    	$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-event__meta,
                       		{{WRAPPER}} .elementor-event .tribe-address',
				'condition' => [
					'skin_grid_manaslu_show_meta!' => '',
				],
			]
    	...
    	$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-event__meta' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'skin_grid_manaslu_show_meta!' => '',
				],
    	...
    	$this->add_control(
			'calendar_light_color',
			[
				'label' => __( 'Calendar Light Color', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-event__date .calendar .month' => 'background-color: {{VALUE}}',
				],
        		'condition' => [
					'skin_grid_manaslu_show_date!' => '',
				],
          ...
          <?php
            if( '' !== $this->parent->get_instance_value_skin( 'show_date' ) ) {
              ...
              echo '<div class="elementor-event__date">' .
                     ...
                     '</div>' .
                     '<div class="detail">' .
                       '<span class="date">' . tribe_get_start_date( get_the_ID(), false, 'D, M d, Y' ) . '</span>' .
