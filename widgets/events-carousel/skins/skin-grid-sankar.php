...
class Skin_Grid_Sankar extends Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/be-events-carousel/section_layout/before_section_end', [ $this, 'register_layout_controls' ] );
		add_action( 'elementor/element/be-events-carousel/section_design_layout/before_section_end', [ $this, 'registerd_design_layout_controls' ] );
		add_action( 'elementor/element/be-events-carousel/section_design_layout/after_section_end', [ $this, 'register_design_box_section_controls' ] );
		add_action( 'elementor/element/be-events-carousel/section_design_layout/after_section_end', [ $this, 'register_design_image_section_controls' ] );
		add_action( 'elementor/element/be-events-carousel/section_design_layout/after_section_end', [ $this, 'register_design_content_section_controls' ] );
	...
	public function get_title() {
		return __( 'Grid Sankar', 'alone-addons' );
	}
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event__date span' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_sankar_show_date!' => '',
				],
    ...
    $this->add_control(
			'date_secondary_color',
			[
				'label' => __( 'Secondary Color', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event__organizer .infor span,
           {{WRAPPER}} .elementor-event__address,
           {{WRAPPER}} .elementor-event .tribe-address' => 'color: {{VALUE}};',
          '{{WRAPPER}} .elementor-event__address' => 'border-color: {{VALUE}};',
          '{{WRAPPER}} .elementor-event__address:hover' => 'color: #FFFFFF; background-color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_sankar_show_meta!' => '',
				],
    ...
    $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-event__organizer .infor' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_sankar_show_meta!' => '',
				],
        ...
        <?php if( '' !== $this->parent->get_instance_value_skin( 'show_thumbnail' ) ) { ?>
          ...
          <?php } ?>
            ...
            if( '' !== $this->parent->get_instance_value_skin( 'show_date' ) ) {
              echo tribe_events_event_schedule_details( get_the_ID(), '<div class="elementor-event__date">' . __('Started: ', 'alone-addons'), '</div>' );
            }
          ?>
				</div>
			</article>
