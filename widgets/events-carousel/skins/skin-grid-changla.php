...
class Skin_Grid_Changla extends Skin_Base {
	...
	public function get_id() {
		return 'skin-grid-changla';
	}


	public function get_title() {
		return __( 'Grid Changla', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_changla_show_thumbnail!'=> '',
				],
			]
		);
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
    	...
    	$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_changla_show_address!' => '',
				],
			]
		);
    ...
    $this->add_control(
			...
			[
				'label' => __( 'Organizer', 'alone-addons' ),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_changla_show_meta!' => '',
				],
    ...
    $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-event__organizer' => 'background-color: {{VALUE}}',
				],
        'condition' => [
					'skin_grid_changla_show_meta!' => '',
				],
      ...
      <article id="post-<?php the_ID();  ?>" <?php post_class( $post_classes ); ?> >
        ...
        <?php if( '' !== $this->parent->get_instance_value_skin( 'show_meta' ) ) { ?>
          <div class="elementor-event__meta">
            <?php
              echo '<div class="elementor-event__date">' . tribe_get_start_date( get_the_ID(), false, 'd, M Y' ) . '</div>';

							$organizer_id = get_post_meta( get_the_ID(), '_EventOrganizerID', true);
              if( $organizer_id ) {
								echo '<div class="elementor-event__organizer">' .
												esc_html__('By ', 'alone-addons') .
