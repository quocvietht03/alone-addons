...
class Skin_Grid_Platons extends Skin_Base {
	...
	public function get_id() {
		return 'skin-grid-platons';
	}


	public function get_title() {
		return __( 'Grid Platons', 'alone-addons' );
	}
    ...
    $this->add_group_control(
      ...
      [
        ...
        'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_platons_show_thumbnail!'=> '',
				],
      ]
    );
    ...
    $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_platons_show_goal_progress!' => '',
				],
			]
		);
  ...
  public function register_design_give_form_section_controls(Widget_Base $widget) {
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--platons"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-gateway-radio-list > li label:hover,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-gateway-radio-list > li.give-gateway-option-selected label,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give_terms_agreement label:hover,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give_terms_agreement input[type=checkbox]:checked + label,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] .give_terms_links:hover,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.give-form[data-style="elementor-give-forms-carousel--platons"] .give-total-wrap .give-currency-symbol,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give_terms_agreement input[type=checkbox]:checked + label:before,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
					'.give-form[data-style="elementor-give-forms-carousel--platons"] #give-donation-level-button-wrap .give-btn:hover,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--platons"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--platons"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--platons"] legend,
					 .give-form[data-style="elementor-give-forms-carousel--platons"] .give-submit' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--platons"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--platons"] .give-submit' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--platons"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--platons"] .give-submit:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
    ...
    $this->add_control(
      ...
      [
        ...
        'condition' => [
          'skin_grid_platons_custom_goal_progress!' => '',
        ],
      ]
    );
