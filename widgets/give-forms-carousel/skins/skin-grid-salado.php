...
class Skin_Grid_Salado extends Skin_Base
{
	...
	{
		return 'skin-grid-salado';
	}


	public function get_title()
	{
		return __('Grid Salado', 'alone-addons');
	}
	...
	public function register_layout_controls(Widget_Base $widget)
	{
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => ['custom'],
				'condition' => [
					'skin_grid_salado_show_thumbnail!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_salado_show_donation_button!' => '',
				],
			]
		);
	}
	...
	public function register_design_content_section_controls(Widget_Base $widget)
	{
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_salado_show_goal_progress!' => '',
					'skin_grid_salado_show_thumbnail!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_salado_show_category!' => '',
				],
			]
		);
	...
	public function register_design_give_form_section_controls(Widget_Base $widget)
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--salado"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-gateway-radio-list > li label:hover,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-gateway-radio-list > li.give-gateway-option-selected label,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give_terms_agreement label:hover,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give_terms_agreement input[type=checkbox]:checked + label,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] .give_terms_links:hover,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.give-form[data-style="elementor-give-forms-carousel--salado"] .give-total-wrap .give-currency-symbol,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give_terms_agreement input[type=checkbox]:checked + label:before,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
					'.give-form[data-style="elementor-give-forms-carousel--salado"] #give-donation-level-button-wrap .give-btn:hover,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--salado"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--salado"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--salado"] legend,
					 .give-form[data-style="elementor-give-forms-carousel--salado"] .give-submit' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--salado"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--salado"] .give-submit' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--salado"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--salado"] .give-submit:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	public function register_design_goal_progress_section_controls(Widget_Base $widget)
	{
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_salado_custom_goal_progress!' => '',
				],
			]
		);
					...
					if ('' !== $this->parent->get_instance_value_skin('show_donation_button')) {
						if (!Template::getActiveID($form_id)) {
							...
							add_filter('give_form_html_tags', function ($form_html_tags, $form) {
								$form_html_tags['data-style'] = 'elementor-give-forms-carousel--salado';
