...
class Skin_List_Saltoro extends Skin_Base {
	...
	public function get_title() {
		return __( 'List Saltoro', 'alone-addons' );
	}
	...
	public function register_design_give_form_section_controls(Widget_Base $widget) {
			...
			[
				...
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--list-saltoro"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-forms-carousel--list-saltoro"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					 .give-form[data-style="elementor-give-forms-carousel--list-saltoro"] #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					...
					'.give-form[data-style="elementor-give-forms-carousel--list-saltoro"] .give-total-wrap .give-currency-symbol,
					 ...
					 .give-form[data-style="elementor-give-forms-carousel--list-saltoro"] #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 ...
					 .give-form[data-style="elementor-give-forms-carousel--list-saltoro"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--list-saltoro"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--list-saltoro"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--list-saltoro"] legend,
					 .give-form[data-style="elementor-give-forms-carousel--list-saltoro"] .give-submit' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--list-saltoro"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--list-saltoro"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
