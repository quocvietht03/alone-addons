	...
	public function register_layout_controls(Widget_Base $widget)
	{
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_together_show_donation_button!' => '',
				],
			]
		);
	}
	...
	public function register_design_content_section_controls(Widget_Base $widget)
	{
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_together_show_goal_progress!' => '',
					'skin_grid_together_show_thumbnail!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_together_show_category!' => '',
				],
			]
		);
	...
	public function register_design_give_form_section_controls(Widget_Base $widget)
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--together"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-gateway-radio-list > li label:hover,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-gateway-radio-list > li.give-gateway-option-selected label,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give_terms_agreement label:hover,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give_terms_agreement input[type=checkbox]:checked + label,
					 .give-form[data-style="elementor-give-forms-carousel--together"] .give_terms_links:hover,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.give-form[data-style="elementor-give-forms-carousel--together"] .give-total-wrap .give-currency-symbol,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-gateway-radio-list > li.give-gateway-option-selected label:after,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give_terms_agreement input[type=checkbox]:checked + label:before,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
					'.give-form[data-style="elementor-give-forms-carousel--together"] #give-donation-level-button-wrap .give-btn:hover,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 .give-form[data-style="elementor-give-forms-carousel--together"] #give_terms_agreement input[type=checkbox]:checked + label:before' => 'border-color: {{VALUE}};',
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--together"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--together"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--together"] legend,
					 .give-form[data-style="elementor-give-forms-carousel--together"] .give-submit' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--together"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--together"] .give-submit' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--together"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'.give-form[data-style="elementor-give-forms-carousel--together"] .give-submit:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
	...
	public function register_design_goal_progress_section_controls(Widget_Base $widget)
	{
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_together_custom_goal_progress!' => '',
				],
			]
		);
					...
					if ('' !== $this->parent->get_instance_value_skin('show_donation_button')) {
						if (!Template::getActiveID($form_id)) {
							...
							add_filter('give_form_html_tags', function ($form_html_tags, $form) {
								$form_html_tags['data-style'] = 'elementor-give-forms-carousel--together';
