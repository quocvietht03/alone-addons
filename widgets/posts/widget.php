<?php
namespace AloneAddons\Widgets\Posts;
...
class Be_Posts extends Widget_Base {
	...
	public function get_title() {
		return __( 'Be Posts', 'alone-addons' );
	}
			...
			?>
				<div class="<?php echo esc_attr( $classes ); ?>">
					<ul class="elementor-filter" data-type="post">
						<?php
							echo '<li>
										<a class="elementor-filter__link active" href="#" data-filter="all">' . esc_html__( 'All', 'alone-addons' ) . '</a>
									</li>';
