...
class Skin_List_Nevado extends Skin_Base {
	...
	public function get_id() {
		return 'skin-list-nevado';
	}


	public function get_title() {
		return __( 'List Nevado', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_list_nevado_show_thumbnail!'=> '',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::NUMBER,
				'default' => apply_filters( 'nevado_excerpt_length', 15 ),
				'condition' => [
					'skin_list_nevado_show_excerpt!' => '',
				],
			]
		);
	...
	public function registerd_design_layout_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-post:not(:last-child)' => 'margin-bottom: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}}',
				],
			]
		);
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-post__date span' => 'color: {{VALUE}};',
          '{{WRAPPER}} .elementor-post__date' => 'border-color: {{VALUE}};',
				],
				'condition' => [
					'skin_list_nevado_show_date!' => '',
				],
        ...
        <div class="elementor-post__content">
          <?php if( '' !== $this->parent->get_instance_value_skin('show_date') ) { ?>
            <div class="elementor-post__date">
              <?php
                echo '<span>' . esc_html( get_the_date( 'd' ) ) . '</span>' .
          ...
          <?php if( '' !== $this->parent->get_instance_value_skin('show_meta') ) { ?>
              ...
              <li>
                  ...
                  echo '<a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">'.
                    alone_addons_get_icon_svg('user', 16) .
              ...
              <li>
  	            <a class="elementor-post__comment-count" href="<?php comments_link(); ?>">
  	              <?php echo alone_addons_get_icon_svg('comment', 16); ?>
