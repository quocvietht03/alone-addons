...
class Skin_Grid_Baruntse extends Skin_Base {
	...
	public function get_id() {
		return 'skin-grid-baruntse';
	}


	public function get_title() {
		return __( 'Grid Baruntse', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_baruntse_show_thumbnail!'=> '',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::NUMBER,
				'default' => apply_filters( 'baruntse_excerpt_length', 25 ),
				'condition' => [
					'skin_grid_baruntse_show_excerpt!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => apply_filters( 'baruntse_excerpt_more', '' ),
				'condition' => [
					'skin_grid_baruntse_show_excerpt!' => '',
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_baruntse_show_read_more!' => '',
				],
			]
		);
	}
	...
	public function register_design_image_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .elementor-post__thumbnail-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        <div class="elementor-post__content">
          ...
          <?php
						if( '' !== $this->parent->get_instance_value_skin('show_read_more') ) {
							echo '<a class="elementor-post__read-more" href="' . get_the_permalink() . '">' . $this->parent->get_instance_value_skin('read_more_text') . alone_addons_get_icon_svg( 'chevron-right', 10 ) . '</a>';
						}
					?>
        </div>
			</article>
