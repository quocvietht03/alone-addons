...
class Skin_Grid_Somoni extends Skin_Base {
	...
	public function get_id() {
		return 'skin-grid-somoni';
	}


	public function get_title() {
		return __( 'Grid Somoni', 'alone-addons' );
	}
    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_somoni_show_thumbnail!'=> '',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_somoni_show_read_more!' => '',
				],
			]
		);
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->start_controls_section(
		...
		$this->add_control(
          ...
          '{{WRAPPER}} .elementor-post__read-more svg' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_somoni_show_read_more!' => '',
				],
		...
		$this->add_control(
          ...
          '{{WRAPPER}} .elementor-post__read-more:hover svg' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_somoni_show_read_more!' => '',
				],
        ...
        <div class="elementor-post__content">
          ...
          <?php
						if( '' !== $this->parent->get_instance_value_skin('show_read_more' ) ){
							echo '<a class="elementor-post__read-more" href="' . get_the_permalink() . '">' . $this->parent->get_instance_value_skin('read_more_text') . alone_addons_get_icon_svg('chevron-right', 20) . '</a>';
						}
					?>
        </div>
			</article>
