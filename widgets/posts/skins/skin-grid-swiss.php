    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_swiss_show_read_more!' => '',
				],
			]
		);
                        ...
                        if( '' !== $this->parent->get_instance_value_skin('show_read_more' ) ){
                            echo '<a class="elementor-post__read-more" href="' . get_the_permalink() . '">' . 
                                ...
                                '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path d="M6.34357 5.31048L12.7351 5.31039M12.7351 5.31039L12.7351 11.611M12.7351 5.31039L5.31045 12.735" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </a>';
                        }
                    ?>
