    ...
    $this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'custom' ],
				'condition' => [
					'skin_grid_castor_show_thumbnail!'=> '',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::NUMBER,
				'default' => apply_filters( 'castor_excerpt_length', 15 ),
				'condition' => [
					'skin_grid_castor_show_excerpt!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => apply_filters( 'castor_excerpt_more', '' ),
				'condition' => [
					'skin_grid_castor_show_excerpt!' => '',
				],
			]
