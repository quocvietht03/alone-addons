    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_gangri_show_read_more!' => '',
				],
			]
		);
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->start_controls_section(
		...
		$this->add_control(
			'date_day_color',
			[
				'label' => __( 'Day Color', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-post__date .d' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_gangri_show_date!' => '',
				],
    ...
    $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin_grid_gangri_show_comment_count!' => '',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-post__comment-count' => 'color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_gangri_show_comment_count!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-post__comment-count',
				'condition' => [
					'skin_grid_gangri_show_comment_count!' => '',
				],
			]
	...
	protected function render_post() {
        ...
        <div class="elementor-post__content">
	            ...
	            <?php
	                   ...
	                   '<span class="y">' . get_the_date('Y') . '</span>';
							?>
	          </div>
					<?php } ?>

          <div class="elementor-post__inner">
            <?php
            ...
            <?php if( '' !== $this->parent->get_instance_value_skin('show_comment_count' ) ){ ?>
              <a class="elementor-post__comment-count" href="<?php comments_link(); ?>">
                <?php
                  echo alone_addons_get_icon_svg('comment', 14);
            ...
            <?php
                ...
                alone_addons_get_icon_svg('arrow-right', 14) .
                '</a>';
  						}
  					?>
          </div>
