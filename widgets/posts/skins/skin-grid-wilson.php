    ...
    $this->start_controls_section(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					' {{WRAPPER}} .elementor-post__date' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_wilson_show_date!' => '',
				],
      ...
      $post_classes .= ' has-date';
        ...
        <div class="elementor-post__content">
          ...
          <?php if( '' !== $this->parent->get_instance_value_skin('show_meta') ) { ?>
  	          ...
  	          <li>
                <?php
  								echo '<a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">'.'<span>' . esc_html__('Author ', 'alone-addons') . '</span>' . get_the_author() .
  								'</a>';
  							?>
  	          </li>
  	        </ul>
