    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'condition' => [
					'skin_grid_pumori_show_read_more!' => '',
				],
			]
		);
    ...
    $this->start_controls_section(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-post__meta' => 'background-color: {{VALUE}};',
				],
				'condition' => [
					'skin_grid_pumori_show_meta!' => '',
				],
		...
		$this->add_responsive_control(
			'meta_padding',
			[
				'label' => __( 'Meta Padding', 'alone-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-post__meta' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
				'condition' => [
					'skin_grid_pumori_show_meta!' => '',
				],
