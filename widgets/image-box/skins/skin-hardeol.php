...
class Skin_Hardeol extends Skin_Base {
	...
	public function get_title() {
		return __( 'Hardeol', 'alone-addons' );
	}
  ...
  public function register_design_image_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-image-box__read-more' => 'border-color: {{VALUE}};',
				],
			]
		);
    ...
    $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-image-box__read-more:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
