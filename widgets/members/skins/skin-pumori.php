<?php
namespace AloneAddons\Widgets\Members\Skins;
...
class Skin_Pumori extends Skin_Base {
    ...
    add_action( 'elementor/element/be-members/section_design_layout/after_section_end', [ $this, 'register_design_box_section_controls' ] );
		add_action( 'elementor/element/be-members/section_design_layout/after_section_end', [ $this, 'register_design_filter_section_controls' ] );
  ...
  public function register_design_content_section_controls( Widget_Base $widget ) {
    ...
    $this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-member__socials a:hover' => 'background-color: {{VALUE}} !important;',
				],
			]
		);
	...
	protected function render_post() {
		...
		$post_classes = 'elementor-member elementor-item';

		$group = array();
		foreach ( get_the_terms( get_the_ID(), 'team_category' ) as $tax ) {
			$group[] = $tax->slug;
		}
