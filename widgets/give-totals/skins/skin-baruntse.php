		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'.give-form[data-style="elementor-give-totals--baruntse"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-totals--baruntse"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					 .give-form[data-style="elementor-give-totals--baruntse"] #give-donation-level-button-wrap .give-btn:not(.give-default-level):hover,
					 ...
					 .give-form[data-style="elementor-give-totals--baruntse"] #give-final-total-wrap .give-final-total-amount' => 'color: {{VALUE}};',
					'.give-form[data-style="elementor-give-totals--baruntse"] .give-total-wrap .give-currency-symbol,
					 .give-form[data-style="elementor-give-totals--baruntse"] #give-donation-level-button-wrap .give-btn.give-default-level,
					 ...
					 .give-form[data-style="elementor-give-totals--baruntse"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
					'.give-form[data-style="elementor-give-totals--baruntse"] #give-donation-level-button-wrap .give-btn:hover,
					 .give-form[data-style="elementor-give-totals--baruntse"] #give-donation-level-button-wrap .give-btn.give-default-level,
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-totals--baruntse"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-totals--baruntse"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] .give-btn-modal,
					 .give-form[data-style="elementor-give-totals--baruntse"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
