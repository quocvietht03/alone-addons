  ...
  public function register_design_give_total_box_controls( Widget_Base $widget ) {
	...
	public function register_design_give_total_section_controls( Widget_Base $widget ) {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Goal Color', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Goal Typography', 'alone-addons' ),
				'default' => '',
		...
		$this->add_control(
			'goal_percent_color',
			[
				'label' => __( 'Collected Color', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Collected Typography', 'alone-addons' ),
				'default' => '',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Progress Bar', 'alone-addons' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Border Progress Color', 'alone-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
			...
			[
				...
				'selectors' => [
					...
					'.give-form[data-style="elementor-give-totals--wilson"] .give-total-wrap #give-amount,
					 .give-form[data-style="elementor-give-totals--wilson"] #give-donation-level-button-wrap .give-btn:not(.give-default-level),
					...
					'.give-form[data-style="elementor-give-totals--wilson"] .give-total-wrap .give-currency-symbol,
					 ...
					 .give-form[data-style="elementor-give-totals--wilson"] #give-final-total-wrap .give-donation-total-label' => 'background-color: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-totals--wilson"]' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					.give-form[data-style="elementor-give-totals--wilson"]' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] > .give-btn,
					 .give-form[data-style="elementor-give-totals--wilson"] legend,
					 .give-form[data-style="elementor-give-totals--wilson"] .give-submit' => 'font-family: "{{VALUE}}", sans-serif',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] .give-btn-modal,
					 .give-form[data-style="elementor-give-totals--wilson"] .give-submit' => 'color: {{VALUE}};',
				],
			]
		);
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} form[id*=give-form] .give-btn-modal:hover,
					 .give-form[data-style="elementor-give-totals--wilson"] .give-submit:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		?>
			...
			<div class="elementor-gt-header">
				<?php
					...
					echo alone_addons_give_totals_box ( $args, $bar_opts );
