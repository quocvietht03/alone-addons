<?php
namespace AloneAddons\Widgets\Base_Carousel;
...
class Be_Base_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Be Base Carousel', 'alone-addons' );
	}
	...
	protected function register_layout_section_controls() {
		...
		$repeater->add_control(
			'list_title', [
				...
				'default' => __( 'This is the heading' , 'alone-addons' ),
				'label_block' => true,
			]
		);
			...
			[
				...
				'default' => [
					[
						...
						'list_title' => __( 'This is the heading #1', 'alone-addons' ),
						'list_url' => '',
					],
					[
						'list_image' => Utils::get_placeholder_image_src(),
						'list_title' => __( 'This is the heading #2', 'alone-addons' ),
						'list_url' => '',
					],
					[
						'list_image' => Utils::get_placeholder_image_src(),
						'list_title' => __( 'This is the heading #3', 'alone-addons' ),
						'list_url' => '',
					],
					[
						'list_image' => Utils::get_placeholder_image_src(),
						'list_title' => __( 'This is the heading #4', 'alone-addons' ),
						'list_url' => '',
					],
					[
						'list_image' => Utils::get_placeholder_image_src(),
						'list_title' => __( 'This is the heading #5', 'alone-addons' ),
						'list_url' => '',
					],
				],
	...
	protected function register_design_box_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-slide' => 'border-style: solid; border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-slide' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-slide' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-slide__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name' => 'box_shadow',
				'selector' => '{{WRAPPER}} .elementor-slide',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .elementor-slide' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slide' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .elementor-slide:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slide:hover' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-slide:hover' => 'border-color: {{VALUE}}',
				],
			]
		);
    ...
    $this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-slide__title' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title!' => '',
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-slide__title:hover,
					 {{WRAPPER}} .elementor-slide__title a:hover' => 'color: {{VALUE}};',
				],
				'condition' => [
					'show_title!' => '',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'default' => '',
				'selector' => '{{WRAPPER}} .elementor-slide__title',
				'condition' => [
					'show_title!' => '',
				],
			]
	...
	public function render_loop_header() {
		...
		if( $settings['navigation_show_always'] ) {
			...
			$classes .= ' elementor-swiper--navigation-no-always';
		}
		...
		?>
			...
			<div class="swiper-slide">
				<div class="elementor-slide">
					...
					<div class="elementor-slide__content">
						<?php
							if( !empty( $item['list_title'] ) && '' !== $settings['show_title'] ) {

								if( !empty( $item['list_url'] ) ) {
									echo '<h3 class="elementor-slide__title"><a href="' . esc_url( $item['list_url'] ) . '">' . $item['list_title'] . '</a></h3>';
								} else {
									echo '<h3 class="elementor-slide__title">' . $item['list_title'] . '</h3>';
								}
